...
def main():
    ...
    while True:
        ...
        _, _, _, _, hour, minute, second = rtc.datetime()
        ...
        hour_ang = (6 + hour)%12
        min_ang = (30 + minute)%60
        sec_ang = (30 + second)%60
        ...
        minute_ang = ((min_ang*pi_div_30)+(sec_ang*pi_div_1800))
        # calculate the angle of the second hand on radians
        second_ang = (sec_ang*pi_div_30)
